...
class LcqmcProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_new.txt")), "train")
...
# -------------- 用于读取csv格式的similarity数据 ----------------
class SimProcessor(DataProcessor):
    """Processor for csv format similarity数据"""
    ...
    def get_dev_examples(self, data_dir):
        return self._create_examples(
            self._read_csv(Path(data_dir)/"dev_0211.csv"), "dev")


# -------------- QA Processor ----------------------

class QAProcessor(DataProcessor):
    """Processor for the QA data set (GLUE version)."""
...
class StyleProcessor(DataProcessor):
    """Processor for the QA data set (GLUE version)."""
    ...
    def get_train_examples(self, data_dir):
        ...
        logger.info("Logging at {}".format(os.path.join(data_dir, 'train_0211.csv')))
        return self._create_examples(
            self._read_txt(os.path.join(data_dir, "style_dialogue.albert.train.txt")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_txt(os.path.join(data_dir, "style_dialogue.albert.valid.txt")), "dev")
